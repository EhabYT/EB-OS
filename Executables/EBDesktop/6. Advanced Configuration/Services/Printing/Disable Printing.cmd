...
if /i not "%~1"=="/silent" if /i not "%~1"=="/justcontext" call "%windir%\EBModules\Scripts\serviceWarning.cmd" %*
...
call "%windir%\EBModules\Scripts\setSvc.cmd" Spooler 4
call "%windir%\EBModules\Scripts\setSvc.cmd" PrintWorkFlowUserSvc 4

call "%windir%\EBModules\Scripts\settingsPages.cmd" /hide printers
