...
set "settingName=KernelParameters"
...
reg add "HKLM\SOFTWARE\EBOS\Services\%settingName%" /v state /t REG_DWORD /d "0" /f > nul
goto finish

:enable
bcdedit /set {globalsettings} optionsedit true > nul
reg add "HKLM\SOFTWARE\EBOS\Services\%settingName%" /v state /t REG_DWORD /d "1" /f > nul
goto finish
