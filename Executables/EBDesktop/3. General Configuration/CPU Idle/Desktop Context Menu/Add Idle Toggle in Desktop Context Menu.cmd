...
reg add "HKEY_CLASSES_ROOT\DesktopBackground\Shell\CpuIdle\Shell\Disable Idle\Command" /d "cmd /c \"\"%%windir%%\\EBDesktop\\3. General Configuration\\CPU Idle\\Disable Idle.cmd\"\" /silent" /f
...
reg add "HKEY_CLASSES_ROOT\DesktopBackground\Shell\CpuIdle\Shell\Enable Idle\Command" /d "cmd /c \"\"%%windir%%\\EBDesktop\\3. General Configuration\\CPU Idle\\Enable Idle (default).cmd\"\" /silent" /f
