...
reg add "HKLM\SOFTWARE\EBOS\Services%settingNameFeature%" /v state /t REG_DWORD /d %stateValue% /f >nul
reg add "HKLM\SOFTWARE\EBOS\Services%settingNameFeature%" /v path /t REG_SZ /d "%scriptPath%" /f >nul
reg add "HKLM\SOFTWARE\EBOS\Services%settingNameFeature%" /v days /t REG_DWORD /d %FeatureDeferral% /f >nul

reg add "HKLM\SOFTWARE\EBOS\Services%settingNameQuality%" /v state /t REG_DWORD /d %stateValue% /f >nul
reg add "HKLM\SOFTWARE\EBOS\Services%settingNameQuality%" /v path /t REG_SZ /d "%scriptPath%" /f >nul
reg add "HKLM\SOFTWARE\EBOS\Services%settingNameQuality%" /v days /t REG_DWORD /d %QualityDeferral% /f >nul
