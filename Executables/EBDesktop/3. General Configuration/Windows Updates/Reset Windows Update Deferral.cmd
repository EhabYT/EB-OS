...
reg add "HKLM\SOFTWARE\EBOS\Services%settingNameFeature%" /v days /t REG_DWORD /d 0 /f >nul
...
reg add "HKLM\SOFTWARE\EBOS\Services%settingNameQuality%" /v days /t REG_DWORD /d 0 /f >nul
