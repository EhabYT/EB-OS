...
if %errorlevel%==1 (
	start "Enabling Hibernation" "%windir%\EBDesktop\3. General Configuration\Hibernation\Enable Hibernation.cmd"
) else (
	start "Disabling Hibernation" "%windir%\EBDesktop\3. General Configuration\Hibernation\Disable Hibernation (default).cmd"
)
