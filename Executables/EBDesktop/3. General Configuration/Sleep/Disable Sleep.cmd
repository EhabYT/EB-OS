...
if %errorlevel%==1 (
	call "%windir%\EBDesktop\3. General Configuration\Hibernation\Disable Hibernation (default).cmd" /silent
) else (
	call "%windir%\EBDesktop\3. General Configuration\Hibernation\Enable Hibernation.cmd" /silent
)
