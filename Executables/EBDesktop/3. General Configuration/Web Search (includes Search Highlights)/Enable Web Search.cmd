...
:: Main settings
call "%windir%\EBModules\Scripts\settingsPages.cmd" /unhide search-permissions /silent
(
...
if %errorlevel%==1 call "%windir%\EBDesktop\3. General Configuration\Search Indexing\Enable Search Indexing.cmd" /silent & set ____restart=true
exit /b