...
$packageInstall = "$windir\EBModules\Scripts\packageInstall.ps1"
...
$package = "*Z-EBOS-NoTelemetry-Package*"
...
Removing the package restores the telemetry components, which can aid in troubleshooting. If
   resolving the issue involves removing the package, please report this as an issue to the EB OS team.`n
"@
	Write-BulletPoint @"
EB OS retains policies that should disable telemetry even after the package removal. These policies
