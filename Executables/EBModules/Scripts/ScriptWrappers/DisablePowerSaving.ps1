...
# Duplicate Ultimate Performance power scheme, customize it and make it the EB OS power scheme
...
powercfg /changename scheme_current "EB OS Power Scheme" "Power scheme optimized for optimal latency and performance."
...
& "$windir\EBModules\Scripts\toggleDev.cmd" -Disable '@("ACPI Processor Aggregator", "Microsoft Windows Management Interface for ACPI")' | Out-Null
