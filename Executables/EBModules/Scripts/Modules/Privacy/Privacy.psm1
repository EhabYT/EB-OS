...
function Disable-RecallSnapshots {
    Start-Process -FilePath "reg" -ArgumentList "import `"EBDesktop\3. General Configuration\AI Features\Recall\Disable Recall Support (default).reg`"" -NoNewWindow -Wait
}
