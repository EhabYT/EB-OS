...
if not exist "%servicesPath%" (
	echo Services in EB OS folder not found, can't continue.
	if "%*"=="" pause
	exit /b 1
)
...
echo This will reset the configuration of services in the EB OS folder.
...
:main
%title% "Enabling services in the EB OS folder... This might take a while."
...
set "atlasOther=%windir%\EBModules\Other"
...
echo 2) Restore a full services backup of the default EB OS services
echo 3) Nothing
echo]
