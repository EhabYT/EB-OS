...
- Path: `\EBModules\Tools\multichoice.exe`
...
- Path: `\EBModules\Tools\SetTimerResolution.exe`
    ...
    - Version: v1.0.0
- Path: `\EBDesktop\3. General Configuration\Timer Resolution\! MeasureSleep.exe`
...
> [!NOTE]  
> This is included in the Playbook and isn't in the EBModules.
